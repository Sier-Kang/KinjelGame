...
void SKlChatShowWidget::Construct(const FArguments& InArgs)
{
	//Get GameStyle
...
void SKlChatShowWidget::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
{
...
void SKlChatShowWidget::AddMessage(FText NewName, FText NewContent)
{
...
void SKlChatShowWidget::InitializeItem()
{
	for (int i = 0; i < 10; ++i) {
